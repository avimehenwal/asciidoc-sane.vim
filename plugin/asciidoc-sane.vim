...
nnoremap <Leader>1 :call s:Heading(0)<CR>
nnoremap <Leader>2 :call s:Heading(1)<CR>
nnoremap <Leader>3 :call s:Heading(2)<CR>
nnoremap <Leader>4 :call s:Heading(3)<CR>
nnoremap <Leader>5 :call s:Heading(4)<CR>
nnoremap <Leader>6 :call s:Heading(5)<CR>
